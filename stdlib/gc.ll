...
$"\01?PrintList@?$GcList@VGcObjList@@@@QAEXXZ" = comdat any

$"\01?PushFront@?$GcList@VGcObjList@@@@QAEXPAUGcObj@@@Z" = comdat any

$"\01?PushFront@?$GcList@VGcRootList@@@@QAEXPAUGcObj@@@Z" = comdat any

$"\01?PrintList@?$GcList@VGcRootList@@@@QAEXXZ" = comdat any

$"\01?ListName@GcObjList@@SAPBDXZ" = comdat any

$"\01?GetNext@GcObjList@@SAPAUGcObj@@PAU2@@Z" = comdat any

$"\01?SetNext@GcObjList@@SAXPAUGcObj@@0@Z" = comdat any

$"\01?SetNext@GcRootList@@SAXPAUGcObj@@0@Z" = comdat any

$"\01?ListName@GcRootList@@SAPBDXZ" = comdat any

$"\01?GetNext@GcRootList@@SAPAUGcObj@@PAU2@@Z" = comdat any
...
@"\01?gc_obj_list@@3V?$GcList@VGcObjList@@@@A" = global %class.GcList zeroinitializer, align 4
@"\01?gc_root_list@@3V?$GcList@VGcRootList@@@@A" = global %class.GcList.0 zeroinitializer, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?PrintList@?$GcList@VGcObjList@@@@QAEXXZ"(%class.GcList*) #0 comdat align 2 {
  ...
  %7 = call i8* @"\01?ListName@GcObjList@@SAPBDXZ"()
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"\01??_C@_09EBJFJNG@?$CFs?5start?6?$AA@", i32 0, i32 0), i8* %7)
  br label %9
...
; <label>:12:                                     ; preds = %9
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"\01??_C@_07FNDMELDM@obj?$DN?$CFd?6?$AA@", i32 0, i32 0), i32 %14)
  ...
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"\01??_C@_0BD@HGGAKDEI@?5?5is_reachable?$DN?$CFd?6?$AA@", i32 0, i32 0), i32 %20)
  %22 = load %struct.GcObj*, %struct.GcObj** %3, align 4
  %23 = getelementptr inbounds %struct.GcObj, %struct.GcObj* %22, i32 0, i32 3
  %24 = load i8*, i8** %23, align 4
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"\01??_C@_0P@DPHCNOIJ@?5?5typename?$DN?$CFs?6?$AA@", i32 0, i32 0), i8* %24)
  %26 = load %struct.GcObj*, %struct.GcObj** %3, align 4
  %27 = call %struct.GcObj* @"\01?GetNext@GcObjList@@SAPAUGcObj@@PAU2@@Z"(%struct.GcObj* %26)
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?PushFront@?$GcList@VGcObjList@@@@QAEXPAUGcObj@@@Z"(%class.GcList*, %struct.GcObj*) #0 comdat align 2 {
  %3 = alloca %struct.GcObj*, align 4
  ...
  call void @"\01?SetNext@GcObjList@@SAXPAUGcObj@@0@Z"(%struct.GcObj* %8, %struct.GcObj* %7)
  %9 = load %struct.GcObj*, %struct.GcObj** %3, align 4
...
define void @gc_add_root(%struct.GcObj*) #0 {
  ...
  call x86_thiscallcc void @"\01?PushFront@?$GcList@VGcRootList@@@@QAEXPAUGcObj@@@Z"(%class.GcList.0* @"\01?gc_root_list@@3V?$GcList@VGcRootList@@@@A", %struct.GcObj* %3)
  call x86_thiscallcc void @"\01?PrintList@?$GcList@VGcRootList@@@@QAEXXZ"(%class.GcList.0* @"\01?gc_root_list@@3V?$GcList@VGcRootList@@@@A")
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?PushFront@?$GcList@VGcRootList@@@@QAEXPAUGcObj@@@Z"(%class.GcList.0*, %struct.GcObj*) #0 comdat align 2 {
  %3 = alloca %struct.GcObj*, align 4
  ...
  %7 = load %struct.GcObj*, %struct.GcObj** %6, align 4
  %8 = load %struct.GcObj*, %struct.GcObj** %3, align 4
  call void @"\01?SetNext@GcRootList@@SAXPAUGcObj@@0@Z"(%struct.GcObj* %8, %struct.GcObj* %7)
  %9 = load %struct.GcObj*, %struct.GcObj** %3, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?PrintList@?$GcList@VGcRootList@@@@QAEXXZ"(%class.GcList.0*) #0 comdat align 2 {
  ...
  %6 = load %struct.GcObj*, %struct.GcObj** %5, align 4
  store %struct.GcObj* %6, %struct.GcObj** %3, align 4
  %7 = call i8* @"\01?ListName@GcRootList@@SAPBDXZ"()
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"\01??_C@_09EBJFJNG@?$CFs?5start?6?$AA@", i32 0, i32 0), i8* %7)
  br label %9
...
; <label>:12:                                     ; preds = %9
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"\01??_C@_0P@DPHCNOIJ@?5?5typename?$DN?$CFs?6?$AA@", i32 0, i32 0), i8* %24)
  %26 = load %struct.GcObj*, %struct.GcObj** %3, align 4
  %27 = call %struct.GcObj* @"\01?GetNext@GcRootList@@SAPAUGcObj@@PAU2@@Z"(%struct.GcObj* %26)
  store %struct.GcObj* %27, %struct.GcObj** %3, align 4
  br label %9

; <label>:28:                                     ; preds = %9
  %29 = call i8* @"\01?ListName@GcRootList@@SAPBDXZ"()
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"\01??_C@_08BPFNJJP@?$CFs?5end?6?6?$AA@", i32 0, i32 0), i8* %29)
  ret void
}
...
define linkonce_odr i8* @"\01?ListName@GcObjList@@SAPBDXZ"() #2 comdat align 2 {
  ret i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"\01??_C@_07DGBOGBKN@gc?5objs?$AA@", i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr %struct.GcObj* @"\01?GetNext@GcObjList@@SAPAUGcObj@@PAU2@@Z"(%struct.GcObj*) #2 comdat align 2 {
  %2 = alloca %struct.GcObj*, align 4
  store %struct.GcObj* %0, %struct.GcObj** %2, align 4
  %3 = load %struct.GcObj*, %struct.GcObj** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01?SetNext@GcObjList@@SAXPAUGcObj@@0@Z"(%struct.GcObj*, %struct.GcObj*) #2 comdat align 2 {
  %3 = alloca %struct.GcObj*, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01?SetNext@GcRootList@@SAXPAUGcObj@@0@Z"(%struct.GcObj*, %struct.GcObj*) #2 comdat align 2 {
  %3 = alloca %struct.GcObj*, align 4
  %4 = alloca %struct.GcObj*, align 4
  store %struct.GcObj* %1, %struct.GcObj** %3, align 4
  store %struct.GcObj* %0, %struct.GcObj** %4, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr i8* @"\01?ListName@GcRootList@@SAPBDXZ"() #2 comdat align 2 {
  ret i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"\01??_C@_08NJAKNIEC@gc?5roots?$AA@", i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr %struct.GcObj* @"\01?GetNext@GcRootList@@SAPAUGcObj@@PAU2@@Z"(%struct.GcObj*) #2 comdat align 2 {
  %2 = alloca %struct.GcObj*, align 4
  store %struct.GcObj* %0, %struct.GcObj** %2, align 4
  %3 = load %struct.GcObj*, %struct.GcObj** %2, align 4
